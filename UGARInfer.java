...
//
    ...
    UGARInfer(String inputPath, String outputPath, int index, double hTheta, int iteration, int lnum, int rNum, int seqLength, int msSize) throws IOException, InterruptedException, ParseException {
